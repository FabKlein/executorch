...
Tensor& add_f32_out(
  ...
  return run_float_binary_out<float, float, arm_elementwise_add_f32>(
      context,
      input1,
      input2,
      activation_min,
...
#else
  fail_cmsis_float_kernel_unavailable(context, "add_f32_out", "float32");
  return out;
#endif
}
...
Tensor& add_f16_out(
  ...
  return run_float_binary_out<
      ...
      "arm_elementwise_add_f16");
#else
  fail_cmsis_float_kernel_unavailable(context, "add_f16_out", "float16");
  return out;
#endif
}
